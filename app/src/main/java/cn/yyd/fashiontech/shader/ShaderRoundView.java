 ...
 */
public class ShaderRoundView extends View {
    ...
    private float mRoundRadius = 10;

    public ShaderRoundView(Context context) {
        this(context, null);
    }

    public ShaderRoundView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShaderRoundView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mRoundRectF = new RectF(0, 0, w, h);
    ...
    private void computeBitmapSize() {
        ...
        //  初始化 矩形尺寸
        mRoundRectF = new RectF(0, 0, mBitmapWidth, mBitmapHeight);
