...
public class AsyncTimeout extends Timeout {
  ...
  public final Sink sink(final Sink sink) {
    return new Sink() {
       public void write(com.example.collect.Buffer source, long byteCount) throws IOException {
  ...
  public final Source source(final Source source) {
    return new Source() {
      @Override public long read(com.example.collect.Buffer sink, long byteCount) throws IOException {
        boolean throwOnTimeout = false;
        enter();
        try {
