...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
	...
	private void setParam(){
		...
		if(mEngineType.equals(SpeechConstant.TYPE_CLOUD)) {
			...
			//设置合成语速
			mTts.setParameter(SpeechConstant.SPEED, mSharedPreferences.getString("speed_preference", "150"));
			//设置合成音调
			mTts.setParameter(SpeechConstant.PITCH, mSharedPreferences.getString("pitch_preference", "0"));
			//设置合成音量
